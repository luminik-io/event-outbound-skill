...
emd=$(grep -rn -- "—" README.md marketplace/INSTALL.md marketplace/README.md marketplace/SKILL.md marketplace/CHANGELOG.md skills/event-outbound/SKILL.md CHANGELOG.md 2>/dev/null || true)
if [[ -z "$emd" ]]; then
