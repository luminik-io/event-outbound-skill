...
> Source: "The Ultimate Cold Email Data Report" (Gong × 30 Minutes to President's Club × Jason Bay / Outbound Squad). Analyses **85M+ cold emails** to identify what top reps do differently. PDF original at `~/Downloads/Josh_Braun/The Ultimate Cold Email Data Report.pdf`.
>
> This file complements `josh-braun-frameworks.md` with the exact reply-rate / open-rate deltas the report measured. Where the JB synthesis says "buzzwords kill replies," this file says "buzzwords drop reply rate by 57%." Use these as ranking weights in the validator and as priority cues in the prompt.
...
After the JB encoding lands (current in-flight PR `feat/josh-braun-encoding`), file these as a follow-up PR or issue:
...
- Original PDF: `~/Downloads/Josh_Braun/The Ultimate Cold Email Data Report.pdf` (12 pages).
- Cited in `josh-braun-frameworks.md` "Appendix: source file inventory" as cross-source baseline.
