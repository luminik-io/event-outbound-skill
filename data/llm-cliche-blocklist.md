...
| `best-in-class` / `world-class` / `industry-leading` | Same; biased self-claim per JB doctrine |
| `award-winning` | Same |
| `revolutionary` | Same |
